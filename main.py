...
def predict_on_test_set(args):
    ...
    predictor = Predictor(config, checkpoint_path=working_dir+'experiments/checkpoint_best.pth.tar')
    # predictor = Predictor(config, checkpoint_path=working_dir+'experiments/checkpoint_last.pth.tar')
...
if __name__ == "__main__":
    ...
    if args.predict_on_test_set:
        ...
        if args.filename is None:
            ...
            plt.figure()
            plt.imshow(image, cmap=plt.cm.BrBG)
            plt.figure()
